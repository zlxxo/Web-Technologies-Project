function generisi() {
    ...
    GenerisiRasporede.dodajAktivnost(okvir, "WT", "predavanje", 9, 12, dani[0]);
    GenerisiRasporede.dodajAktivnost(okvir, "WT", "vježbe", 12, 13.5, dani[0]);
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "predavanje", 14, 17, dani[0]);
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "vježbe", 12.5, 14, dani[1]);
    GenerisiRasporede.dodajAktivnost(okvir, "DM", "tutorijal", 14, 16, dani[1]);
    GenerisiRasporede.dodajAktivnost(okvir, "DM", "predavanje", 16, 19, dani[1]);
    GenerisiRasporede.dodajAktivnost(okvir, "OI", "predavanje", 12, 15, dani[2]);
    
    var okvir1 = document.getElementById("okvir1");
    GenerisiRasporede.iscrtajRaspored(okvir1, dani, 12, 12);
    GenerisiRasporede.dodajAktivnost(okvir1, "RMA", "vježbe", 12.5, 14, dani[1]);
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "vježbe", 12.5, 14, dani[1]);
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "vježbe", 12.5, 14, "U");
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "vježbe", 12.05, 14, dani[1]);
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "vježbe", 15, 14, "Cetvrtak");
    GenerisiRasporede.dodajAktivnost(okvir, "RMA", "tutorijal", 11.5, 13.5, dani[4]);
}